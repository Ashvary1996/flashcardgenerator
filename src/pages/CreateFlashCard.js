            ...
            <Form>
                ...
                <div className="flex flex-col md:flex-row " name="groupUpperdiv">
                  ...
                  <div>
                    ...
                    {values.groupImage ? (
                      ...
                      <label
                        htmlFor="groupImage"
                        className="order w-40 h-[12px]  cursor-pointer px-2  mx-6 my-6 mt-[31px] p-4  border border-blue-700 flex  items-center justify-center rounded-lg "
                      >
              ...
              <div className="createFlashcardDiv">
                <FieldArray
                  name="term"
                  render={(moreTerm) => (
                    <div className="flex-col p-3 mt-4 overflow-hidden bg-white rounded-md">
                      {values.term && values.term.map((term, index) => (
                        <div className="relative flex-row flex-wrap w-full border-gray-400 termsDiv md:flex md:space-x-4 md:items-center" key={index}>
                          ...
                          <div className="flex flex-col">
                            ...
                            <Field
                              ...
                              className="p-2 mt-4 text-sm text-gray-900 border border-gray-400 rounded-md w-50 md:w-72 bg-gray-50"
                          ...
                          <div className="flex flex-col">
                            ...
                            <Field
                              as="textarea"
                              className="w-full p-2 mt-5 text-sm text-gray-700 transition-all duration-500 border border-gray-400 rounded-md resize-none h-14 focus:h-24 md:w-72 sm:w-55 bg-gray-50 "
