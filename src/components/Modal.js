                ...
                <div className="border-2 border-gray-200 flex justify-between items-center mt-4 py-2 px-4 ">
                  ...
                  >
                    ...
                    <svg
                      ...
                      height="24"
                      viewBox="0 0 24 24"
                      className="fill-green-500 ml-2 mr-2  active:bg-gray-400 active:fill-white duration-200   rounded-full"
                    >
                  ...
                  <button>
                    <BsShare className="fill-blue-500    active:bg-gray-400 active:fill-black duration-200 " />
                  </button>
                </div>
